...
namespace Tour.Domain.Models.Viator.Response
{
    public class CommonResponse
    {
        ...
        public object ErrorMessageText { get; set; }
    ...
    public static class Serialize<T> where T:class
    {
        public static string ToJson(T self) => JsonConvert.SerializeObject(self, CommonConverter.Settings);
    }
